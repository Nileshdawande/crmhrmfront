                          ...
                          <div className="ms-panel">
                              ...
                              <div className="ms-panel-body">
                                  <form className="w-50" onSubmit={(event)=>{addData(event,urlData)}}>
                                    ...
                                    <input type="text" name="type" className="form-control" placeholder="Epic" required="required" />
                                    </div>
                                    ...
                                    <button className="btn btn-dark rounded-0 create_btn">Create task type</button>
                                    </div>
