...
const ShowSalaryHeadTable=()=>
{

    const paginateurl = ApiUrl+"/salary-head?page=";
                                    ...
                                    <table className="table table-hover thead-primary text-center">
                                        ...
                                        <tbody>
                                        {
                                           alldata.map((final_data,index)=>(
                                             ...
                                             <td>{index+1}</td>
                                             <td align="center">
                                               <input type="text" className="form-control" value={final_data.salary_head_name} style={{width:'fit-content'}} onChange={(event)=>{handleInput(event,index)}} disabled="disabled" />
                                             </td>

                                             <td align="center">
                                               <input type="text" className="form-control" value={final_data.type} style={{width:'fit-content'}} onChange={(event)=>{handleInput(event,index)}} disabled="disabled" />
                                             </td>
...
export default ShowSalaryHeadTable;
